...
# Cloud SDK imports are lazy-loaded inside their provider classes to avoid
# ImportError when the packages are not installed (e.g. slim deployments).
...
class GCSStorageProvider(StorageProvider):
    ...
    def upload_file(
        ...
        except self._GoogleCloudError as e:
